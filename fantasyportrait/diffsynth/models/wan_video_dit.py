...
class WanT2VCrossAttentionProcessor:
...
class WanT2VCrossAttention(WanSelfAttention):
    def __init__(self, dim, num_heads, window_size=(-1, -1), qk_norm=True, eps=1e-6):
        ...
        processor = WanT2VCrossAttentionProcessor()
    ...
    def forward(
        self, x, context, context_lens, adapter_proj, ip_scale: float = 1.0, **kwargs
    ):
        """
        x:              [B, L1, C].
        context:        [B, L2, C].
        ...
        if adapter_proj is None:
            ...
            return self.processor(
                self, x, context, context_lens, adapter_proj, ip_scale
            )
...
class WanI2VCrossAttention(WanSelfAttention):
    ...
    def forward(
        ...
        context_lens,
        adapter_proj,
        adapter_context_lens,
        latents_num_frames,
        ip_scale: float = 1.0,
        adapter_attn_mask=None,
        **kwargs,
    ):
        """
        x:              [B, L1, C].
    ...
    def forward(
        ...
        **kwargs,
        ...
        kwargs = dict(
            ...
            adapter_context_lens=adapter_context_lens,
            ip_scale=ip_scale,
